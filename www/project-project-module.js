...
var ProjectPage = /** @class */ (function () {
    ...
    ProjectPage.prototype.toast = function (message) {
    ...
    ProjectPage.prototype.addProjects = function () {
        var _this = this;
        var _a = this.form, title = _a.title, prof_type = _a.prof_type, const_cost = _a.const_cost, final_cost = _a.final_cost, variable = _a.variable, prof_cost = _a.prof_cost, year = _a.year, completed_at = _a.completed_at, description = _a.description, client_name = _a.client_name, pl_name = _a.pl_name, pl_email = _a.pl_email, pl_phone = _a.pl_phone, proj_street1 = _a.proj_street1, proj_street2 = _a.proj_street2, proj_city = _a.proj_city, proj_state = _a.proj_state, proj_zip = _a.proj_zip;
        if (title.length == 0) {
            this.toast("Please fill title");
            return;
        }
        if (prof_type.length == 0) {
            this.toast("Please fill Type");
            return;
        }
        if (const_cost.length == 0) {
            this.toast("Please fill Construction Cost");
            return;
        }
        if (final_cost.length == 0) {
            this.toast("Please fill Final Cost");
            return;
        }
        if (prof_cost.length == 0) {
            this.toast("Please fill Professional Cost");
            return;
        }
        if (year.length == 0) {
            this.toast("Please fill Start Date");
            return;
        }
        if (completed_at.length == 0) {
            this.toast("Please fill Construction Complete Date");
            return;
        }
        if (description.length == 0) {
            this.toast("Please fill description");
            return;
        }
        if (client_name.length == 0) {
            this.toast("Please fill Client Name");
            return;
        }
        if (pl_name.length == 0) {
            this.toast("Please fill Project Leader Name");
            return;
        }
        if (pl_email.length == 0) {
            this.toast("Please fill Project Leader Email");
            return;
        }
        if (pl_phone.length == 0) {
            this.toast("Please fill Project Leader Phone number");
            return;
        }
        if (proj_street1.length == 0) {
            this.toast("Please fill Project Location Street1");
            return;
        }
        if (proj_street2.length == 0) {
            this.toast("Please fill Project Location Street2");
            return;
        }
        if (proj_city.length == 0) {
            this.toast("Please fill Project Location City");
            return;
        }
        if (proj_state.length == 0) {
            this.toast("Please fill Project Location State");
            return;
        }
        if (proj_zip.length == 0) {
            this.toast("Please fill Project Location Zipcode");
            return;
        }
        ...
        this.restApi.post('professional/add-project', { user_id: this.authService.user.userId, data: this.form }).subscribe(function (res) {
            if (res && res.status) {
                _this.toastController.create({ message: res.message, duration: 2000 })
                    .then(function (toast) { return toast.present(); });
                if (res.id != "exist") {
                    _this.getProjects();
                    _this.segment = 'paper';
