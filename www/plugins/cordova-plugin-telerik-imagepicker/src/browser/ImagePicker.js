cordova.define("cordova-plugin-telerik-imagepicker.ImagePickerProxy", function(require, exports, module) { const cacheDirectory = (require('./isChrome')()) ? 'filesystem:' + window.location.origin + '/temporary/' : 'file:///temporary/';
