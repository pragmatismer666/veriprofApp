...
const routes = [
    {
        ...
        children: [
            { path: 'professional', loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_home_professional_professional_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./professional/professional.module */ 8857)).then(m => m.ProfessionalPageModule) },
            { path: 'assessor', loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_home_assessor_assessor_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./assessor/assessor.module */ 8950)).then(m => m.AssessorPageModule) },
        ]
    }
];
