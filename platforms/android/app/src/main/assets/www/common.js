...
/* harmony import */ var _rest_api_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rest-api.service */ 4714);
...
let AuthenticateService = class AuthenticateService {
    constructor(restApi, navCtrl, storage) {
    ...
    saveProfileData(personProfile, businessProfile, hofficeProfile) {
...
AuthenticateService.ctorParameters = () => [
    { type: _rest_api_service__WEBPACK_IMPORTED_MODULE_0__.RestApiService },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__.NavController },
    { type: _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_3__.Storage }
];
AuthenticateService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ 3819);
/* harmony import */ var _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ionic-native/in-app-browser/ngx */ 9048);
...
let RestApiService = class RestApiService {
    ...
    constructor(toastController, http, iab) {
        this.toastController = toastController;
        this.http = http;
        this.iab = iab;
        // base_url = "http://back.veriprof.co.za/";
        this.base_url = "https://back.veriprof.co.za/";
    }
    url(endpoint) {
    ...
    postFile(fileToUpload, endpoint, folderName) {
        let url = this.url(endpoint);
...
RestApiService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Injectable)({
        providedIn: 'root'
    })
], RestApiService);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,G_ionic_updated_veriprof_veriprof_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,G_ionic_updated_veriprof_veriprof_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,G_ionic_updated_veriprof_veriprof_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,G_ionic_updated_veriprof_veriprof_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
